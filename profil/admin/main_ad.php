...
<!DOCTYPE html>
<html lang="fr">
<head><meta charset="UTF-8"><meta http-equiv="X-UA-Compatible" content="IE=edge"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Accueil Admin</title><link href="../css/bootstrap.css" rel="stylesheet"><link href="../css/bootstrap-icons.css" rel="stylesheet"><link href="../css/sidenav.css" rel="stylesheet"><link href="../css/header2.css" rel="stylesheet"><link href="../css/index.css" rel="stylesheet"><link href="../css/profilpage.css" rel="stylesheet"><script src="../js/bootstrap.js"></script><script src="../js/plotly-2.18.2.min.js"></script><script src="../js/graph.js"></script>
</head>
...
<h2>
  ...
  <?php 
    ...
    // Préparation d'une requête SQL pour obtenir le nom et le prénom de l'utilisateur actuellement connecté
    $requete = $bdd->prepare('SELECT nom, prenom FROM utilisateurs WHERE token = ?');

    // Exécution de la requête avec le token de l'utilisateur comme paramètre
    $requete->execute([$_SESSION['user']]);

    // Récupération du résultat de la requête
    $resultat = $requete->fetch();

    // Affichage du prénom et du nom de l'utilisateur avec la première lettre en majuscule
