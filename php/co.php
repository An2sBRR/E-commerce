<!--/*cette page va avoir le formulaire de co */--->
<!DOCTYPE html>
    <html lang="en">
        <head>
            <meta charset="UTF-8">
...
*/
            ...
            <form action="connexion.php" method="post">
                ...
                <div class="inputs">
                    ...
                    <div class="forget">
                         <a href="#">mot de passe oublié</a></label>
                    </div>
                    ...
                    <p class="inscription">Je suis <span style="text-decoration: underline; color: red;">vendeur </span>et je n'ai pas de <span>compte</span>.Je m'en <span><a href="inscription2.php">crée</span> un.</p>
