...
if($("#reussite").length){
    document.getElementById("tout").innerHTML = "<h4 class='confirmation'> Votre commande est validée !<br> Vous pouvez la consulter dans votre page profil. Merci pour votre confiance !</h4>";
